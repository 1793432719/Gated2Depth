...
def build_unet(input_img):
    ...
    with tf.variable_scope('unet'):
        ...
        conv4 = tf.layers.dropout(conv4,rate=0.5)
        ...
        conv5 = tf.layers.dropout(conv5,rate=0.5)
        ...
        conv7 = tf.layers.dropout(conv7,rate=0.5)

        up8 = upsample_and_concat(conv7, conv2, 64, 128)
        conv8 = slim.conv2d(up8, 64, [3, 3], rate=1, activation_fn=lrelu, scope='g_conv8_1')
        conv8 = slim.conv2d(conv8, 64, [3, 3], rate=1, activation_fn=lrelu, scope='g_conv8_2')
        # conv8 = tf.nn.relu(conv8)
        conv8 = tf.layers.dropout(conv8,rate=0.5)

        up9 = upsample_and_concat(conv8, conv1, 32, 64)
        conv9 = slim.conv2d(up9, 32, [3, 3], rate=1, activation_fn=lrelu, scope='g_conv9_1')
        conv9 = slim.conv2d(conv9, 32, [3, 3], rate=1, activation_fn=lrelu, scope='g_conv9_2')
        # conv9 = tf.nn.relu(conv9)
        conv9 = tf.layers.dropout(conv9,rate=0.5)
